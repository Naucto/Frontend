  ...
  constructor() {
    ...
    effect(() => {
      ...
      untracked(() => {
        ...
        // anonymous path cannot even retry -- there is no token to refresh. A declined sign-in
        // has to cancel the request, or the game that made it waits on it forever.
        this.signedIn.run(
          () => {
