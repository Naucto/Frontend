-- The Coin Rush tutorial's draw_coins and draw_players a few grabs in: one
-- coin taken and not yet respawned, the score rows at the top left.
...
shared = {
  players = {
    ["1"] = { x = 154, y = 116, col = 2,  score = 3 },
    ["2"] = { x = 236, y = 132, col = 11, score = 2 },
  },
  coins = {
